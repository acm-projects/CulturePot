...
class MyPreferences extends StatelessWidget {
  ...
  void userNext(BuildContext context) {
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
          builder: (context) =>
              SignSuccess() //here pass the actual values of these variables, for example false if the payment isn't successfull..etc
          ),
    );
  }
          ...
          child: Column(children: <Widget>[
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  MyPrefButton(text: 'Mexican 🇲🇽'),
                  // const SizedBox(width : 5),
                  MyPrefButton(text: 'Indian 🇮🇳'),

                  MyPrefButton(text: 'Eritrean 🇪🇷'),
                  //const SizedBox(width: 5,),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  //const SizedBox(width: 5),
                  MyPrefButton(text: 'France 🇫🇷'),
                  const SizedBox(width: 2),

                  MyPrefButton(text: 'Japanese 🇯🇵'),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  MyPrefButton(text: 'Nigerian 🇳🇬'),
                  //const SizedBox(width : 8),

                  MyPrefButton(text: 'China 🇨🇳'),

                  //const SizedBox(width: 8,),
                  MyPrefButton(text: 'Thailand 🇹🇭'),
                  //const SizedBox(width: 8,),
                ],
              ),
            ),
